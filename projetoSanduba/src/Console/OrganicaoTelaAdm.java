...
public class OrganicaoTelaAdm {
	...
	public void opcoesCase1(Scanner sc, Adm adm, RepositorioUsuarioArrayList listUsuarios,
			VisualizacaoMenu visualizacaoMenu) throws DadoInvalidoException, DadoDuplicadoException {
		int case1 = -1;
		...
		do {
			...
			try {
				...
				case 2:
					sc.nextLine();
					System.out.println("✏️ Deseja obter informaões de um cliente em especifio ou de todos? |");
				...
				case 3:
					sc.nextLine();
					System.out.println("✏️ Insira o nome do Cliente que deseja alterar dados:");
					String nome = sc.nextLine();
				...
				case 4:
					sc.nextLine();
					System.out.println("✏️ Insira o nome do Cliente que deseja remover");
					String nome1 = sc.nextLine();
					listUsuarios.deletar(listUsuarios.procurarNome(nome1));
					break;
				case 5:
					sc.nextLine();
					System.out.println("✏️ Insira o nome do Cliente que deseja buscar:");
					...
					break;
				case 6:
					Gambiarras.textoLento("> Voltando ao menu...", 70);
	...
	public void opcoesCase2(Scanner sc, Adm adm, RepositorioUsuarioArrayList listUsuarios,
			VisualizacaoMenu visualizacaoMenu) throws DadoInvalidoException, DadoDuplicadoException {
	...
	public void opcoesCase3(Scanner sc, Adm adm, RepositorioUsuarioArrayList listUsuarios,
			VisualizacaoMenu visualizacaoMenu, RepositorioJogoArrayList listJogos, ControleDeJogos controleJogos)
		...
		do {
			try {
				...
				case 6:
					...
					if (opcao21 == 1) {
						System.out.println(
								"> Insira o ano de referência: todos os jogos lançados até esse ano sofrerão desconto. (ex:2010) ");
						int ano = sc.nextInt();
